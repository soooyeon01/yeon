	...
	<nav
		...
		<form
			...
			<div class="input-group">
				...
				%>
				<a href="${root}/user/login" type="button" class="btn"
					...
					<div class="card mb-4  mytb">
						...
						<div class="card-body">
							<table class="datatable-table ttt">
								...
								<tbody>
									<c:forEach var="viewCntList"
										items="${requestScope.viewCntList}" varStatus="status">
										<c:set var="fixdate"
					...
					<div class="card mb-4  mytb">
						...
						<div class="card-body">
							<table class="datatable-table ttt">
								...
								<tbody>
									<c:forEach var="likeCntList"
										items="${requestScope.likeCntList}" varStatus="status">
										<c:set var="fixdate"
											value="${fn:substring(likeCntList.reg_date, 0, 11)}" />
										<tr>
											<%-- <td>${communityDTO.c_no}</td> --%>
											<td><a
												href="${pageContext.servletContext.contextPath}/community/commuSel?c_no=${likeCntList.c_no}">${likeCntList.title}
													(${likeCntList.reply_cnt})</a></td>
