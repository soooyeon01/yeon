...
<div class="container mt-3">
  ...
  <form action="${pageContext.servletContext.contextPath}/notice/notUp?notice_no=${selectone.notice_no}" method="post">
  	<input type="hidden" name="notice_no" value="${selectcone.notice_no}">
    ...
    <div class="row">
    	...
    	<div class="row">
       	...
       	<button type="submit" class="register col p-3 btn btn-warning" onclick="upNot();">전송</button>
    </div>
  </form>
</div>
