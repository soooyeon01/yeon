...
<body class="sb-nav-fixed bgcolor">
	...
	<nav class="tab sb-topnav2 navbar navbar-expand; bg-white">
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="${root}/pet/petall">
			<b>공고</b>
		</a>
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="${root}/shel/shelall">
			<b>보호소</b>
		</a>
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="${root}/with/withca">
			<b>위드펫</b>
		</a>
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="${root}/community/clist">
			<b>커뮤니티</b>
		</a>
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="${root}/notice/nlist">
			<b>공지사항</b>
		</a>
	</nav>
					...
					<div class="card-body" style="padding: 40px 140px 30px 140px; text-align: center;">
						...
						<c:forEach var="P_DTO" items="${petdetailList}">
							...
							<div style="float: right;">
								...
								<label>
									<input type="checkbox" class="image-checkbox" id="fa" name="favorite" style="margin: 5px; display: none;" value="${P_DTO.pet_notice_no}">
									<img class="img_fa1" name="favorite" data-value="${P_DTO.pet_notice_no}" src="../resources/image/fa11.png" style="${isLiked ? 'display:none;' : ''}">
									<img class="img_fa2" name="favorite" data-value="${P_DTO.pet_notice_no}" src="../resources/image/fa22.png" style="${!isLiked ? 'display:none;' : ''}">
								</label>
							</div>
						...
						<button type="button" class="btn btn-warning" onclick="back();" style="display: inline; margin: 30px auto 30px auto;">목록</button>
					</div>
				</div>
			</div>
		</main>
