...
<body class="sb-nav-fixed bgcolor">
	...
	<nav class="tab sb-topnav2 navbar navbar-expand; bg-white">
		...
		<a class="pt-3 pb-3 flex-sm-fill text-sm-center nav-link" href="javascript:void(0)" onclick="moveC();">
			<b>커뮤니티</b>
		</a>
									...
									<c:if test="${not empty P_DTO}">
										<div class="data">
											<a href="javascript:void(0);" onclick="checkLoginAndRedirect(${P_DTO.pet_notice_no});">
												<img src="${P_DTO.popfile}" alt="펫이미지" style="width: 250px; height: 300px; border: 1px solid #feeaa5; border-radius: 10px;" />
											</a>
								...
								<form method="get" name="search-form" action="${root}/pet/petall" autocomplete="off">
									<table id="table">
										<tr>
											...
											<td>
												<button type="submit" onclick="return getSearchList();" class="btn btn-warning">검색</button>
											</td>
										</tr>
									</table>
								</form>
