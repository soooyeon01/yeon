		...
		<ul class="datatable-pagination-list">
			...
			<li class="datatable-pagination-list-item"><c:if
					...
					<a href="javascript:void(0);"
						onclick="prev('${pageMaker.startPage -1}','${param.category3}','${param.type}','${param.keyword}','${param.region}');"
			...
			<c:forEach begin="${pageMaker.startPage }"
				...
				<li class="datatable-pagination-list-item"><a
					...
					onclick=" pageNum('${status.index}','${param.category3}','${param.type}','${param.keyword}','${param.region}');"
			...
			<li class="datatable-pagination-list-item"><c:if
					test="${pageMaker.next }">
					<a href="javascript:void(0);"
						onclick="next('${pageMaker.endPage + 1}','${param.category3}','${param.type}','${param.keyword}','${param.region}');"
						class="datatable-pagination-list-item-link">›</a>
				</c:if></li>
		</ul>
	</nav>
...
<script>
	function prev(prevPage, category3, type, keyword, region) {
		...
		location.href = "${pageContext.servletContext.contextPath}/with/withall?category3="
				...
				+ "&type="
				+ type
				+ "&keyword=" + keyword + "&pageNum=" + prevPage;
	}
	...
	function next(nextPage, category3, type, keyword, region) {
		...
		location.href = "${pageContext.servletContext.contextPath}/with/withall?category3="
				...
				+ "&type="
				+ type
				+ "&keyword=" + keyword + "&pageNum=" + nextPage;
	}
</script>
