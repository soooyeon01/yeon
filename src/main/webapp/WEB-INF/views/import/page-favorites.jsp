	...
	<nav class="datatable-pagination">
		<ul class="datatable-pagination-list">
			...
			<li class="datatable-pagination-list-item"><c:if
					test="${pageMaker.prev }">
					<a
						href="${pageContext.servletContext.contextPath}/fa/favorites?pageNum=${pageMaker.startPage -1}"
			...
			<c:forEach begin="${pageMaker.startPage }"
				...
				<li class="datatable-pagination-list-item"><a
					href="${pageContext.servletContext.contextPath}/fa/favorites?pageNum=${status.index}"
			...
			<li class="datatable-pagination-list-item"><c:if
					test="${pageMaker.next }">
					<a
						href="${pageContext.servletContext.contextPath}/fa/favorites?pageNum=${pageMaker.endPage + 1}"
						class="datatable-pagination-list-item-link">›</a>
				</c:if></li>
		</ul>
	</nav>
