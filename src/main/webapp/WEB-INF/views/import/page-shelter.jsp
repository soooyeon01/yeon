...
<%@ page import="com.spring.util.PageMaker" %>
	...
	function prev(prevPage){
		...
		location.href="${pageContext.servletContext.contextPath}/shel/shelall?region=" + region + "&pageNum=" + prevPage; 
	}

	function pageNum(page){
		var selectElement = document.getElementById("region-select");
		var region = selectElement.options[selectElement.selectedIndex].value;
		location.href="${pageContext.servletContext.contextPath}/shel/shelall?region=" + region + "&pageNum=" + page; 
	}
	
	function next(nextPage){
		var selectElement = document.getElementById("region-select");
		var region = selectElement.options[selectElement.selectedIndex].value;
		location.href="${pageContext.servletContext.contextPath}/shel/shelall?region=" + region + "&pageNum=" + nextPage; 
	}
