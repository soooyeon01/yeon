...
public class CommunityController {
	...
	/*
	 * @RequestMapping("/clist") public String CommunityList(Model model,Criteria
	 ...
	 * "C:\\STS3\\workspace\\4jojo\\src\\main\\webapp\\resources\\image\\temp";
	 * 
	 ...
	 * 
	 * } // end for return new ResponseEntity<>(list, HttpStatus.OK); }
	 * 
	 * // 오늘 날짜의 경로를 문자열로 생성한다. private String getFolder() { SimpleDateFormat sdf =
	 ...
	 * log.info("fileName : " + fileName); File file = new
	 * File("C:\\STS3\\workspace\\4jojo\\src\\main\\webapp\\resources\\image\\temp"
	 * + fileName); log.info("file:" + file);
	 * 
	 ...
	 * 
	 * try { String downloadName = null; if(userAgent.contains("Trident")) {
	 * log.info("IE browser");
	 * 
	 * downloadName = URLEncoder.encode(resourceName, "UTF-8").replaceAll("\\+",
	 * " "); log.info("Edge name: " + downloadName); }else {
	 * log.info("Chrome browser"); downloadName = new
	 ...
	 * String type) { log.info("deleteFile : " + fileName);
	 * 
	 * File file;
	 * 
	 * try { file = new
	 ...
	 * file.getAbsolutePath().replace("s_", ""); log.info("largetFileName : " +
	 * largeFileName); file = new File(largeFileName); file.delete(); }
	 * }catch(UnsupportedEncodingException e) { e.printStackTrace(); return new
	 * ResponseEntity<>(HttpStatus.NOT_FOUND); }
	 * 
